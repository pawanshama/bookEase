         ...
         <div className='sign-in'>
            ...
            <form onSubmit={handleSubmit} style={{backgroundColor:'blue'}}>
              ...
              placeholder='Username' type="text" name="name" value={volunteer.name} onChange={handleChange} />
               ...
               <div className='personal'>
              <input style={{color:'rgb(223, 228, 234)',fontFamily:'sans-serif'}}
              placeholder='email or userID' type="email" name="email" value={volunteer.email} onChange={handleChange} />
               </div>

               <div className='personal'>
              <input style={{color:'rgb(223, 228, 234)',fontFamily:'sans-serif'}}
              placeholder='password' type="password" name="password" value={volunteer.password} onChange={handleChange} />
               </div>
    
               <div className='personal'>
              <input style={{color:'rgb(223, 228, 234)',fontFamily:'sans-serif'}}
               placeholder='country Name' type="text" name="country" value={volunteer.country} onChange={handleChange}/>
               </div>
             <div style={{display:'flex',flexDirection:'column'}}>
              ...
              <button type='submit' style={{color:'black',backgroundColor:'red',padding:'0.3rem',width:'10rem',
               ...
               <Link className='mid' to = {`/`} style={{color:'black',backgroundColor:'red',
